...
input1: .asciiz "\n Player1 please select the next square (1-9): "
input2: .asciiz "\n Player2 please select the next square (1-9): "
...
addi $t9, $t9, 1 #Player2's turn is next
addi $s1, $s1, 3
j end1
...
sw $a1, 0($a0)
addi $t3, $t3, -1 #Subtract counter.
addi $t9, $t9, -1 #Player1's turn is next
addi $s1, $s1, 3
j end2
...
#Both end1 and end2 are used to determine if Player1 or Player2 wins.
end1: la $a0, grid
